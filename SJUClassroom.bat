...
curl -LJo %COMPUTERNAME%Update%YEARMONTH%.txt https://raw.githubusercontent.com/tait-kelly/Classroomimaging/main/%COMPUTERNAME%Update%YEARMONTH%.txt?token=%GITHUBKEY%
...
if "%errorlevel%"=="0" (
	...
	echo curl -LJo SJUClassroom.bat https://raw.githubusercontent.com/tait-kelly/Classroomimaging/main/SJUClassroom.bat?token=%GITHUBKEY% >> C:\Windows\System32\GroupPolicy\Machine\Scripts\Startup\selfupdate.bat
